    ...
    for pdb in pdb_sequences:
        try:
            ...
            for conf_coords in all_conf_coords:
                ...
                final_target_features_only_coords = torch.cat([ohe_aa, combined_coords], dim=1)
                ...
                final_data.append(
                    tg.data.Data(
                        x=final_input_features_only_coords,
                        y=final_target_features_only_coords,
...
if __name__ == "__main__":
    ...
    torch.save(final_data, "cremp_pyg_data_small_coordsonly.pt")